...
// E.g. if you have constructor(private http:Http) {} inside your class.
// So now that this eventsService injects the HTTP service. This injectable decorator is required.
